...
_ALLOWED_CONFIG_KEYS = frozenset({
    ...
    "ORGANIZE_ENABLED", "ORGANIZE_ON_SYNC", "VFS_CACHE_MODE",
    "VFS_CACHE_MAX_AGE", "VFS_CACHE_MAX_SIZE", "DIR_CACHE_TIME",
    "POLL_INTERVAL", "VFS_READ_AHEAD", "BUFFER_SIZE", "SYNC_INTERVAL_MIN",
})
...
def _sanitize_path(path_str):
    """Resolve a path and block dangerous system directories."""
    if not path_str:
        return None
